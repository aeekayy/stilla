...
psql "postgresql://postgres:postgres@postgres:5432/stilla" -c "INSERT INTO api_keys(id, name, role) VALUES('9923d21c-dbac-421d-a31a-649a849d4c85','master', 'e3f01984-8185-4829-affe-56b84a9913eb')"
