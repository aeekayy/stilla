...
curl -H "Content-Type: application/json" -H "Authorization: Bearer 9923d21c-dbac-421d-a31a-649a849d4c85" -H "HostID: cfacd739-4a13-47ae-82c3-13d6d7ffeb2e" http://localhost:8080/api/v1/config/ -X POST --data '{ "config_name": "kubernetes", "owner": "testuser", "config": { "enabled": true } }'
