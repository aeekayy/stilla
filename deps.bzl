...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_gin_contrib_cache",
        importpath = "github.com/gin-contrib/cache",
        sum = "h1:WA+AJR4kmHDTaLLShCHo/IeWVmmGRZ3Lsr3JQ46tFlE=",
        version = "v1.2.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_gin_gonic_autotls",
        importpath = "github.com/gin-gonic/autotls",
        sum = "h1:SXQWwWGDJHujDlthIij1+jxn3m5IPV8I9Za9bcPzMdo=",
        version = "v0.0.5",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_go_session_gin_session",
        importpath = "github.com/go-session/gin-session",
        sum = "h1:br60vVJFG1egLkX+BJ8f/xKRVi/TVexS2CldgdGI3iY=",
    ...
    go_repository(
        name = "com_github_memcachier_mc_v3",
        importpath = "github.com/memcachier/mc/v3",
        sum = "h1:qii+lDiPKi36O4Xg+HVKwHu6Oq+Gt17b+uEiA0Drwv4=",
        version = "v3.0.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_newrelic_go_agent_v3",
        importpath = "github.com/newrelic/go-agent/v3",
        sum = "h1:hUBAMq/Y2Y9as5/yxQbf0zNde/X7w58cWZkm2flZIaw=",
        version = "v3.20.3",
    )
    go_repository(
        name = "com_github_newrelic_go_agent_v3_integrations_nrgin",
        importpath = "github.com/newrelic/go-agent/v3/integrations/nrgin",
        sum = "h1:Q13S9tFSnQAI1x5fXkdunvUfsPQzmlV4BrSaUI3xhGo=",
        version = "v1.1.3",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_robfig_go_cache",
        importpath = "github.com/robfig/go-cache",
        sum = "h1:pyecQtsPmlkCsMkYhT5iZ+sUXuwee+OvfuJjinEA3ko=",
        version = "v0.0.0-20130306151617-9fc39e0dbf62",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:FZKhBSTydeuffHj9CBjXlR8vQLee1cQyTWYPA6/tqiE=",
        version = "v1.11.0",
    )
    go_repository(
